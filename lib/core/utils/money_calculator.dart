...
class MoneyCalculator {
  ...
  /// Converts an amount expressed in the store's main currency into the
  /// secondary currency using the given rate (units of secondary currency
  /// per 1 unit of main currency).
  static double toSecondaryCurrency({
    required double amountInMainCurrency,
    required double exchangeRate,
  }) {
    return round2(amountInMainCurrency * exchangeRate);
  }
