...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'printPeriodReport': 'Print period report',
      'resetReports': 'Reset reports',
      'resetReportsConfirm': 'This closes out the current period — the invoice log and reports will start fresh from now. Past sales stay saved and are not deleted. Continue?',
      'bluetoothPrinter': 'Bluetooth printer',
      'noPrinterSelected': 'No printer selected',
      'connectedPrinter': 'Selected printer',
      'paperWidth': 'Paper width',
      'selectPrinter': 'Select printer',
      'noPairedPrinters': 'No paired Bluetooth devices found — pair your printer in phone Bluetooth settings first',
    ...
    'ar': {
      ...
      'thisWeek': 'هالأسبوع',
      'thisMonth': 'هالشهر',
      'printPeriodReport': 'طباعة تقرير الفترة',
      'resetReports': 'تصفير التقارير',
      'resetReportsConfirm': 'رح يتصفر سجل الفواتير والتقارير الحالية ويبلش من جديد من هلق. المبيعات القديمة بتضل محفوظة ومش رح تنمسح. بدك تكمل؟',
      'bluetoothPrinter': 'طابعة بلوتوث',
      'noPrinterSelected': 'ما في طابعة محددة',
      'connectedPrinter': 'الطابعة المحددة',
      'paperWidth': 'عرض الورق',
      'selectPrinter': 'اختيار طابعة',
      'noPairedPrinters': 'ما في أجهزة بلوتوث مقترنة — قرن الطابعة أول من إعدادات البلوتوث بالموبايل',
      'printViaBluetooth': 'طباعة عبر البلوتوث',
