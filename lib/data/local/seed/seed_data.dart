...
class SeedData {
  ...
  /// of the previous insertOnConflictUpdate — is important: this method runs
  /// on every app startup, and insertOnConflictUpdate would silently reset
  /// every setting (currency, exchange rate, tax rate, receipt text, PIN,
  /// password) back to these hardcoded defaults on every restart, wiping out
  /// anything changed from the Settings screen.
